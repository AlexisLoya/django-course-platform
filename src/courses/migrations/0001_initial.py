# Generated by Django 5.0 on 2024-09-28 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=120)),
                ('description', models.TextField(blank=True, null=True)),
                ('lesson_type', models.CharField(choices=[('VIDEO', 'Video'), ('BLOG', 'Blog/Text')], default='VIDEO', max_length=10)),
                ('content', django_summernote.fields.SummernoteTextField(default='', help_text='Content for blog/text lessons')),
